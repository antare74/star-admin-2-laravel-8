(function($) {
  ...
  $(function() {
    ...
    $("#performance-line-legend-dark").html(salesTopDark.generateLegend());
    }
    ...
    //   document.getElementById('marketing-overview-legend').innerHTML = marketingOverview.generateLegend();
      $("#marketing-overview-legend").html(marketingOverview.generateLegend());
    }
    ...
    //   document.getElementById('marketing-overview-legend').innerHTML = marketingOverviewDark.generateLegend();
        $("#marketing-overview-legend").html(marketingOverviewDark.generateLegend());
    }
