                                                ...
                                                <table class="table select-table">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex ">
                                                                    <img src="{{ url('base/images/faces/face1.jpg') }}"
                                                                        alt="">
                                                                    <div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex">
                                                                    <img src="{{ url('base/images/faces/face2.jpg') }}"
                                                                        alt="">
                                                                    <div>
                                                                        <h6>Laura Brooks</h6>
                                                                        <p>Head admin</p>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex">
                                                                    <img src="{{ url('base/images/faces/face3.jpg') }}"
                                                                        alt="">
                                                                    <div>
                                                                        <h6>Wayne Murphy</h6>
                                                                        <p>Head admin</p>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex">
                                                                    <img src="{{ url('base/images/faces/face4.jpg') }}"
                                                                        alt="">
                                                                    <div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex">
                                                                    <img src="{{ url('base/images/faces/face5.jpg') }}"
                                                                        alt="">
                                                                    <div>
                                                ...
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="mt-3">
                                                        <div
                                                            ...
                                                            <div class="d-flex">
                                                                <img class="img-sm rounded-10"
                                                                    src="{{ url('base/images/faces/face1.jpg') }}"
                                                                    alt="profile">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex">
                                                                <img class="img-sm rounded-10"
                                                                    src="{{ url('base/images/faces/face2.jpg') }}"
                                                                    alt="profile">
                                                                <div class="wrapper ms-3">
                                                                    <p class="ms-1 mb-1 fw-bold">
                                                                        Wayne Murphy</p>
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex">
                                                                <img class="img-sm rounded-10"
                                                                    src="{{ url('base/images/faces/face3.jpg') }}"
                                                                    alt="profile">
                                                                <div class="wrapper ms-3">
                                                                    <p class="ms-1 mb-1 fw-bold">
                                                                        Katherine Butler</p>
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex">
                                                                <img class="img-sm rounded-10"
                                                                    src="{{ url('base/images/faces/face4.jpg') }}"
                                                                    alt="profile">
                                                                <div class="wrapper ms-3">
                                                                    <p class="ms-1 mb-1 fw-bold">
                                                                        Matthew Bailey</p>
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex">
                                                                <img class="img-sm rounded-10"
                                                                    src="{{ url('base/images/faces/face5.jpg') }}"
                                                                    alt="profile">
                                                                <div class="wrapper ms-3">
                                                                    <p class="ms-1 mb-1 fw-bold">
                                                                        Rafell John</p>
...
<!-- Custom js for this page-->
    <script src="{{ asset('base/js/plugins/chart.js/Chart.min.js') }}"></script>
    <script src="{{ asset('base/js/plugins/progressbar.js/progressbar.min.js') }}"></script>
    <script src="{{ asset('base/js/scripts/dashboard.js') }}"></script>
    <script src="{{ asset('base/js/scripts/jquery.cookie.js') }}" type="text/javascript"></script>
    <script src="{{ asset('base/js/scripts/Chart.roundedBarCharts.js') }}"></script>
